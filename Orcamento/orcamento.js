...
function cadastrarDespesa() {
    ...
    if (despesa.validarDados()) {
        ...
        document.getElementById("modal_body").innerHTML = "Dados Foram Gravados com Sucesso!"
        document.getElementById("modal_butao_button").className = "btn btn-success"
    } else {
        // dialog de erro
        $("#Gravacao").modal("show")
        document.getElementById("modal_titulo_div").className = "modal-header text-danger"
        document.getElementById("modal_titulo").innerHTML = "Erro na Gravação!"
        document.getElementById("modal_body").innerHTML = "Erro na Gravação, Preencha os Campos!"
        document.getElementById("modal_butao_button").className = "btn btn-danger"
    }
}
