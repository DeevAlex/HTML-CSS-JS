...
app.get('/', (requisicao, resposta) => {
    ...
    Nome do Cliente: <input type="text" placeholder="Digite seu Nome" name="nome"></input>
...
// para não ficar dando essa ultima linha direto instale o nodemon

// npm i nodemon --save-dev

// assim é não dai fica olhando se houve alguma alteração
// npx nodemon server.js

// caso não tenha adicionado no script o start coloque: "start": "nodemon server.js"